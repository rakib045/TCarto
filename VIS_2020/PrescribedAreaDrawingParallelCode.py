...
square_grid = 32
iteration = 10
input_data_file = "input/Migration/Migrations_US_2019.txt"
output_img_filename = "TCarto_Parallel_migration_us_2019"
...
if __name__ == "__main__":
    ...
    for x in range(iteration):
        ...
        current_rmse, a, b, c = all_error_calc(values, nodes, grid_count_horizontal, grid_count_vertical, estimation_time,
