...
square_grid = 4
input_data_file_area = 'input/Aggregation_cluster_3_grid_4_4.txt'
output_img_filename = 'output_DivCon_room'
input_img_file = "input/newyork1.jpg"
...
if __name__ == "__main__":
    ...
    values_actual_in_order = read_text_file_actual_order(input_data_file_area, grid_count_horizontal_actual, grid_count_vertical_actual)
    ...
    output_image_path = imageDrawBrighnessChannelTopToBottom(input_img_file, nodes, values_actual_in_order,
